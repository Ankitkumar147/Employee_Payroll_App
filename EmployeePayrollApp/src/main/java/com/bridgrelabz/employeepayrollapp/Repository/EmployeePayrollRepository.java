package com.bridgrelabz.employeepayrollapp.Repository;
...
@Repository
public interface EmployeePayrollRepository extends JpaRepository <EmployeePayrollData, String> {
        ...
        EmployeePayrollData findById(int empId);
}
